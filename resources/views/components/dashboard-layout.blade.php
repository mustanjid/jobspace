            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="/admin/dashboard" class="flex ms-2 md:me-24">
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Job
                            Space</span>
                    </a>
                </div>
                    ...
                    <div class="flex items-center ms-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            <div class="px-4 py-3" role="none">
                                ...
                                <p class="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">
                                    Position - {{ strtoupper(Auth::user()->positions->first()->name) }}
                                </p>
                            </div>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="/admin/employers"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Employers</span>
                        <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">30</span>
                    </a>
                </li>
