    ...
    <div>
        <x-dashboard-layout>
            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-1"">
                <h1 class="text-sm text-center p-2">All Users</h1>
                <!-- Start coding here -->
                                ...
                                <form wire:submit="update">
                                    ...
                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            @error('userName')
                                                <span
                                                    class="font-medium mt-2 text-xs text-red-600">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select id="role" wire:model="userRole"
                                                ...
                                                @foreach (\App\Models\Position::all() as $role)
                                                    <option {!! $user->position == $role->name ? 'selected' : '' !!} value="{{ $role->id }}">
                                                        {{ $role->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('userRole')
